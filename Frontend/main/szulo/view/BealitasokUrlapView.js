...
class UrlapView {
    ...
    #letrehozz() {
        ...
        this.#jelszo();
        this.#szuloElem.append('<div class="container mt-10 border border-dark p-4" id="szulo_adatok">');
        this.#orvosElem = this.#szuloElem.children("#szulo_adatok");
        this.#orvosElem.append("<h2>Szülő adatai</h2>");
        this.#orvosAdatok();
    ...
    #adatFeltolt() {
        ...
        this.submitElem.on("click", (event) => {
            ...
            if (this.#osszesElemValidE) {
                ...
                this.#esemenyTrigger("szuloModosit");
            } else {
